...
class Article
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Style::class, mappedBy="articles")
     */
    private $styles;
    ...
    public function setBuyingYear(?int $buyingYear): self
    {
